...
SOURCE = ROOT / "course-package" / "materials" / "baking-b-exam.md"
...
def analysis_for(topic, question, options, correct_letters, correct_text, is_multiple):
    ...
    if is_multiple:
        return (
            ...
            f"正確選項「{correct_name}」都符合烘焙乙級題庫中的產品分類、配方特性、操作條件或衛生法規。"
...
"""
    ...
    for item in items:
        ...
        source = (
            "勞動部勞動力發展署技能檢定中心，烘焙食品乙級技術士技能檢定學科測試參考資料；"
...
| 01:00 ~ 01:30 | 工作項目 05-07 | 包裝、保存與品質管制 |
| 01:30 ~ 02:00 | 工作項目 08-09 | 成本計算與食品良好衛生規範 |
...
learningGoal: 完成烘焙乙級學科 9 個工作項目的完整題庫練習。
hero_title: 烘焙乙級學科練習
hero_lead: 本題庫共 {total} 題，包含單選與複選題；其中複選題 {multiple_total} 題，系統以答對題數換算百分制。
```
...
- [MD] baking-b-exam.md | 烘焙乙級學科測試參考資料原始題庫
...
tag: 烘焙乙級
title: 烘焙乙級學科測試參考資料
desc: 115.07 版烘焙乙級學科題庫，共 {total} 題，涵蓋產品分類、原料選用、產品製作、品質鑑定、包裝、食品保存、品質管制、成本計算與食品良好衛生規範。
time: 120 分鐘
questions: 共 {total} 題
score: 滿分 100 分
href: 115-baking-b/
