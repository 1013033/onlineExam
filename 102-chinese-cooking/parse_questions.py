...
SOURCE = ROOT / "course-package" / "materials" / "chinese-cooking-102-official-exam.md"
OUTPUT = ROOT / "content.md"

ANSWER_INDEX = {"A": 0, "B": 1, "C": 2, "D": 3}
UNIT_ID = "day1.u-1"
TOPIC = "102 學年度中餐烹調正式競賽學科"
...
102 學年度中餐烹調正式競賽學科第 {item["global_no"]} 題：
{item["question"]}
...
hero_lead: 本試卷共 {total} 題，多數為單選題；第 43 題依原卷標示可接受 B 或 D，系統以答對題數換算百分制。
```
...
desc: 102 學年度商業類科學生技藝競賽中餐烹調學科試題，共 {total} 題，涵蓋食材來源、菜系文化、烹調技法、食品安全、庫房管理與成本換算。
time: 60 分鐘
questions: 共 {total} 題
score: 滿分 100 分
