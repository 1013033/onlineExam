...
SOURCE = ROOT / "course-package" / "materials" / "baking-111-official-exam.md"
OUTPUT = ROOT / "content.md"

TITLE = "111 學年度商業類學生技藝競賽烘焙職種學科正式試題"
STORE_KEY = "111-baking-progress-v1"
PORTAL_ID = "exam-111-baking"
HREF = "111-baking/"
MATERIAL = "baking-111-official-exam.md"

SOURCE_NOTE = (
    "111 學年度商業類學生技藝競賽烘焙職種學科正式試題與參考答案；"
...
def parse_answer_table(text):
    answers = {}
    for no, answer in re.findall(r"\|\s*\*{0,2}(\d+)\*{0,2}\s*\|\s*([A-D](?:\s*或\s*[A-D])?)\s*", text):
...
- 完成 111 學年度商業類學生技藝競賽烘焙職種學科正式試題 {total} 題完整練習。
...
learningGoal: 完成 111 學年度商業類學生技藝競賽烘焙職種學科正式試題 {total} 題練習。
...
- [MD] {MATERIAL} | 111 學年度烘焙職種學科正式試題原始題本
...
tag: 烘焙職種
title: 111 學年度烘焙職種學科正式試題
desc: 111 學年度商業類學生技藝競賽烘焙職種學科正式試題，共 {total} 題，涵蓋油脂乳化、麵包品質、糖與乳製品、巧克力酒類、麵粉分類、配方比例與酵母換算。
time: 60 分鐘
questions: 共 {total} 題
score: 滿分 100 分
href: {HREF}
