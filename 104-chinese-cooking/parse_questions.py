...
SOURCE = ROOT / "course-package" / "materials" / "chinese-cooking-104-official-exam.md"
OUTPUT = ROOT / "content.md"

ANSWER_INDEX = {"A": 0, "B": 1, "C": 2, "D": 3}
UNIT_ID = "day1.u-1"
TOPIC = "104 學年度中餐烹調正式競賽學科"
...
104 學年度中餐烹調正式競賽學科第 {item["global_no"]} 題：
{item["question"]}
...
hero_lead: 本試卷共 {total} 題，多數為單選題；第 32 題與第 50 題依原卷標示為複選答案，系統以答對題數換算百分制。
```
...
desc: 104 學年度商業類科學生技藝競賽中餐烹飪正式學科試卷，共 {total} 題，涵蓋米食黏度、食材產季、器具安全、菜單順序、食品安全與宴席文化。
time: 60 分鐘
questions: 共 {total} 題
score: 滿分 100 分
