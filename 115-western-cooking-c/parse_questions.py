...
SOURCE = ROOT / "course-package" / "materials" / "western-cooking-c-exam.md"
...
EXTRA_REASONS = {
    ...
    "牛乳": "動物性鮮奶油是從牛乳中的乳脂肪分離而得，與牛脂肪或牛肥肉不同。",
    "鱘魚": "魚子醬 Caviar 傳統上是鱘魚卵製成，並非一般魚卵或蝦卵。",
    "15 ～18 度": "肉品處理室需維持低溫以抑制微生物繁殖；本題庫標準為 15～18 度。",
    "15～18 度": "肉品處理室需維持低溫以抑制微生物繁殖；本題庫標準為 15～18 度。",
    "西洋芹": "西洋芹屬蔬菜且膳食纖維含量高，雞肉、魚肉等動物性食材幾乎不含膳食纖維。",
    "味精": "西餐調味以鹽、胡椒、香草、酒類與高湯等為主，味精使用相對少。",
    "胡蘿蔔": "胡蘿蔔富含類胡蘿蔔素，是典型黃橘色蔬菜。",
    "衛生福利部": "食品添加物品名、規格、使用範圍與限量由中央主管機關衛生福利部訂定。",
    "15 日": "食品抽驗結果有疑義時，依法可在期限內向原抽驗機關申請複驗；題庫標準為 15 日內。",
    "總極性化合物": "油炸油劣變可用總極性化合物判斷，超過 25% 即應更換。",
}
...
def analysis_for(topic, question, options, correct_letters, correct_text, is_multiple):
    ...
    if is_multiple:
        return (
            ...
            f"西餐烹調丙級學科的分類、操作條件、衛生規範或法規要求。正確選項「{correct_name}」之所以成立，"
...
"""
    ...
    for item in items:
        ...
        source = (
            "勞動部勞動力發展署技能檢定中心，西餐烹調丙級技術士技能檢定學科測試參考資料；"
...
tag: 西餐烹調丙級
title: 西餐烹調丙級學科測試參考資料
desc: 115.07 版西餐烹調丙級學科題庫，共 {total} 題，涵蓋食物性質及選購、貯存、製備、器皿盤飾、設備器具、營養、成本控制、安全措施、衛生知識與衛生法規。
time: 120 分鐘
questions: 共 {total} 題
score: 滿分 100 分
