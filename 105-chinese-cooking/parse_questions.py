...
SOURCE = ROOT / "course-package" / "materials" / "chinese-cooking-105-official-exam.md"
OUTPUT = ROOT / "content.md"

ANSWER_INDEX = {"A": 0, "B": 1, "C": 2, "D": 3}
UNIT_ID = "day1.u-1"
TOPIC = "105 學年度中餐烹調正式試題學科"
...
105 學年度中餐烹調正式試題學科第 {item["global_no"]} 題：
{item["question"]}
...
desc: 105 學年度商業類科學生技藝競賽中餐烹飪正式學科試卷，共 {total} 題，涵蓋調味、食材部位、菜系文化、食品安全、地方特產與烹調技法。
time: 60 分鐘
questions: 共 {total} 題
score: 滿分 100 分
